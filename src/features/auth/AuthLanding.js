  ...
  return (
    <>
      <div className="flex flex-col justify-end h-full pb-4">
        ...
        <div className="flex">
          <div class="w-full h-14 bg-[#f0ecfc] rounded-2xl justify-center items-center gap-2 inline-flex">
            <div class="w-6 h-6">
        ...
        <div className="flex mt-2">
          <div class="w-full h-14 px-4 py-2 bg-[#dde9f6] rounded-2xl justify-center items-center gap-2 inline-flex">
            <div class="w-6 h-6">
